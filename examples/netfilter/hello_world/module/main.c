...
MODULE_DESCRIPTION("hello_world_nf: some description");
MODULE_LICENSE("GPL");
MODULE_VERSION("0.1");
...
static int __init hello_world_nf_init(void)
{
...
static void __exit hello_world_nf_exit(void)
{
    nf_unregister_net_hook(&init_net, &nfho);
    pr_info("Removed module\n");
}

module_init(hello_world_nf_init);
module_exit(hello_world_nf_exit);
